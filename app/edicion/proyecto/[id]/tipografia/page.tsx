...
interface FormData {
  tipografia1: string;
  base: number;
  Ratio: string; // ¿Este valor debería ser un número?
  interlineado: number;
}
...
export default function Page({ params }: { params: { id: string } }) {
  ...
  const copyToClipboard = () => {
    const cssFormat = `
      --font-family: ${formData.tipografia1};
                ...
                <div>
                  ...
                  <div>
                    <div className="nowrap flex flex-row">
                      <div>
                        <Input
                          list="ListTipografias1"
                          id="tipografia1"
                          name="tipografia1"
                          onChange={handleInputChange}
                          value={formData.tipografia1}
                        />
                        <datalist id="ListTipografias1">
                          {TIENETIPOGRA ? (
